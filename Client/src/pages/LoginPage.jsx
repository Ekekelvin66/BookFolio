...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!result.success) {
      if (result.data?.authMethod === 'google') {   // 👈 catch Google accounts
  ...
  return (
    <div className="auth">
      ...
      <div className="auth-container">
        <h1>Login to your Reading Library</h1>
        ...
        {activeTab === 'google' && (
          <div className="auth-page-form">
            <p className="panel-desc">Sign in quickly and securely with your Google account.</p>
