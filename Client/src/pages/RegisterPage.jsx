...
const Register = () => {
  ...
  const validate = () => {
    ...
    else if (password.trim() !== password) newErrors.password = 'Password cannot start or end with spaces'
    ...
    <div className="auth">
      ...
      <div className="auth-container">
        <div className="auth-card-branch">
          ...
          <p className="panel-desc">Start your reading journey today.</p>
          ...
          <form className="auth-page__form" onSubmit={handleSubmit}>
            ...
            <div className="auth-page__field">
              ...
              {password.length < 8 && (
                <p className={clsx(
                  'auth-page-info',
                  password.length === 0 ? 'auth-page-info--empty' : 'auth-page-info--error'
                )}>
